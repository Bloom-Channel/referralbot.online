export const metadata = {
  title: "About Us",
  description: "The story behind Referralbot.online — a home for real, sourced referral links.",
};
  ...
  return (
    <main className="about-page">
      ...
      <section className="about-post">
        ...
        <p>
          Referralbot.online is that list, opened up: a place to post and find referral links across crypto
